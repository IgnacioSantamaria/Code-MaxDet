...
The main files are: Script_MaxDet_Fig3, Script_MaxDet_Fig4, and Script_MaxDet_Fig5. The rest of the files are functions needed by these scripts. BDRIS_MaxDet is the function that implements the proposed closed-form BD-RIS solution. The function Theta2Bqstem obtains a susceptance matrix, B, with a q-stem structure, which best approximates (in an LS sense) a scattering matrix Theta.
